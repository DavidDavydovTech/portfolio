    ...
    <div className="grid grid-cols-6 gap-6 px-4 md:px-16 xl:px-1/3 py-8 font-mono">
        ...
        <div className="col-span-full lg:col-span-2 rounded-lg bg-gray-200 dark:bg-gray-600 shadow-xl p-4 md:p-8">
            ...
            <p className="text-left">
                ...
                By the age of 12 I started out programming in Action Script 3 via 
                Adobe Flash. Over the years I've learned many programming languages 
                and frameworks along the way fell in love with JavaScript, because of 
                how quickly engineers can go from an idea to a finished product. 
            </p>
        </div>
